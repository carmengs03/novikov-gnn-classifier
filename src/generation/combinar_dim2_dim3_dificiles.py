"""Merge the HARD dim2 (with near-misses close to the boundary) and dim3
datasets into a single file ready for the joint training of the paper.

Identical to combinar_dim2_dim3.py except for the input paths.

Output: dataset_combinado_dim2_dim3_dificiles.pt
"""
import random
import torch
...
SEMILLA = 42
ARCHIVO_2D = "dataset_enriquecido_dim2_50000_DATOS_dificiles.pt"
ARCHIVO_3D = "dataset_novikov_dim3_dificiles.pt"
ARCHIVO_SALIDA = "dataset_combinado_dim2_dim3_dificiles.pt"
