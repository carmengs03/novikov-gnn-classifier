...
def generar_grafo_6(dim_algebra=3):
    """
    Configuration 6): arrows e1<->e2 with components in e1 and e2, arrows e2<->e3 with components in e2 and e3.
    Topology: arrows e1->e2, e2->e1, e2->e3, e3->e2.
