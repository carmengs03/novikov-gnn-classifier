...
def generar_grafo_9(dim_algebra=3):
    """
    Configuration 9): pair {e1,e2} in dir. e1; pair {e2,e3} in dir. e2 and e3; pair {e1,e3} in dir. e1.
    Topology: arrows e2->e1, e3->e2, e2->e3, e3->e1.
